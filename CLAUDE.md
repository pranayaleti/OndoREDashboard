...
English only. All UI text uses `t()` from `react-i18next` but only the `en` locale is loaded. No language switcher.

- Translation files: `public/locales/en/{namespace}.json`
