...
const statusStyles: Record<string, string> = {
  draft: "bg-muted text-slate-600 dark:bg-secondary dark:text-slate-300",
  ...
  withdrawn: "bg-muted text-slate-500 dark:bg-secondary dark:text-slate-400",
}
              ...
              <Table>
                ...
                <TableBody>
                  {applications.map((app) => (
                    <TableRow key={app.id} className="cursor-pointer hover:bg-muted dark:hover:bg-card">
