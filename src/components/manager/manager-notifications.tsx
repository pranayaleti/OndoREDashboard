...
interface Notification {
  id: string
  type: "property" | "maintenance" | "message" | "tenant" | "owner" | "lead"
  title: string
  message: string
  timestamp: Date
  read: boolean
...
const mockNotifications: Notification[] = [
  ...
  },
  {
    ...
    message: "Emergency maintenance request from tenant at 123 Oak St",
    timestamp: new Date(Date.now() - 1000 * 60 * 60), // 1 hour ago
    read: false,
    priority: "urgent",
    actionUrl: "/manager/maintenance",
  ...
  },
  {
    ...
    message: "Property owner sent you a message about lease renewal",
  ...
  },
  {
    id: "4",
    type: "tenant",
    title: "Tenant Issue Reported",
    message: "Tenant reported a complaint about property condition",
    timestamp: new Date(Date.now() - 1000 * 60 * 60 * 6), // 6 hours ago
    read: false,
    priority: "high",
    actionUrl: "/manager/tenants",
  ...
  },
  {
    ...
    message: "New lead inquiry for property at 456 Main St",
...
export default function ManagerNotifications() {
  ...
  const [activeTab, setActiveTab] = useState<"all" | "unread" | "property" | "maintenance" | "messages">("all")
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Stay updated with property management activities
            </p>
          </div>
        </div>
        {unreadCount > 0 && (
